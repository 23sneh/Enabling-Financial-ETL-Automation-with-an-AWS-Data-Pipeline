...
def s3_bucket_data_ingest(access_key_id, secret_access_key, bucket_name, source_data_files_path):
    ...
    #response = client.upload_file(r'/Users/snehpatel/.CMVolumes/Google-Drive-23sneh03/~~~VP_Data_Science/Big Data Engineering/BDE_Projects/ETL_Data_Pipeline_Python_AWS_CLI_S3_Glue_Athena_QuickSight/data/trade_transactions.csv', 'vp-stock-trades-bucket', 'trade_transactions.csv')
    #return response
